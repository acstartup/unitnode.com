    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/33 overflow-y-auto py-10" onClick={handleBackdropClick}>
      ...
      <div className={cn(
        ...
        {googleCompleteSuccess && (
          <div className="absolute inset-0 bg-white/80 background-blur-sm z-10 flex flex-col items-center justify-center p-8 rounded-3xl animate-in fade-in duration-300">
            <button
              onClick={(e) => {
                e.stopPropagation();
        ...
        {showVerificationStep && !isGoogleCompleteStep && (
          <div className="absolute inset-0 bg-white/80 backdrop-blur-md z-10 flex flex-col items-center justify-center p-8 rounded-3xl animate-in fade-in duration-300">
            <div className="relative w-full mb-5">
              <div className="flex justify-center">
                <Image 
        ...
        {/* Company Name */}
        {showCompanyNameStep && !isGoogleCompleteStep && (
