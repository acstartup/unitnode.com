    ...
    return (
        <aside className="h-screen w-60 bg-white border-r border-gray-400 text-black flex flex-col">
                        ...
                        <div className="absolute top-14 left-3 w-64 bg-white border border-gray-300 rounded-md shadow-lg z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                            <div className="p-2">
                                ...
                                <div className="py-1 pb-0">
                                    {/* Settings */}
                                    <Link href="/app/settings" className="w-full px-3 py-2 flex items-center gap-3 hover:bg-gray-100 transition-colors text-left rounded-md">
                                        <svg
            ...
            <nav className="flex-1 px-4 py-6 space-y-1">
                ...
                <Link href="/app/properties" className={`flex items-center px-3 py-2 text-sm rounded-md hover:bg-gray-100 ${
